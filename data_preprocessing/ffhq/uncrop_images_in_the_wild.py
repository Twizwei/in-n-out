...
if __name__ == '__main__':
    ...
    for n_iter, img_file in enumerate(img_files):
        ...
        if os.path.exists(os.path.join(lm_dir, lm_file)):
            ...
            back_im.paste(im_rescale_center_crop_size, (left, upper))
            ...
            # output_img = np.array(back_im) * alpha + np.array(white_canvas) * (1 - alpha)
            ...
            im_origin_rescale.paste(back_im, (left, up))
