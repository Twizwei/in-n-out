...
class TestOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--save_latents', action='store_true', help='Whether to save changed latent codes.')
		...
		self.parser.add_argument('--camera_params_path', required=True, type=str, help="The path to camera parameters")
