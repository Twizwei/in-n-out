...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--latents_train_path', default="/home/yiranx/codes/eg3d/eg3d/CLIPStyle/train_faces.pt", type=str, help="The latents for the training")
		self.parser.add_argument('--latents_test_path', default="/home/yiranx/codes/eg3d/eg3d/CLIPStyle/test_faces.pt", type=str, help="The latents for the validation")
		...
		self.parser.add_argument('--norm_lambda', default=0.5, type=float, help='CLIP embedding norm regularization factor')
		self.parser.add_argument('--lambda_direction', default=1.0, type=float, help='Directional loss adopted from StyleGAN-NADA.')

		self.parser.add_argument('--factor_step', default=0.1, type=float, help='the factor how much mapper result added to the input latent code.')
		...
		self.parser.add_argument('--max_steps', default=50001, type=int, help='Maximum number of training steps')
